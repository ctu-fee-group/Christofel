...
namespace Christofel.Remora.Responders
{
    public abstract class EveryResponder : IEveryResponder
    {
        ...
        public Task<Result> RespondAsync
            (IChannelCreate gatewayEvent, CancellationToken ct = new CancellationToken()) => RespondAnyAsync
            (gatewayEvent, ct);

        public Task<Result> RespondAsync
            (IInteractionCreate gatewayEvent, CancellationToken ct = new CancellationToken()) => RespondAnyAsync
            (gatewayEvent, ct);
