...
{
    public class MessageChannelMigrator : IModelMigrator
    {
        ...
        public MessageChannelMigrator(ReactHandlerContext reactHandlerContext, OldContext oldContext,
            ObtainMessageChannel obtainMessageChannel, ILogger<MessageChannelMigrator> logger)
        {
